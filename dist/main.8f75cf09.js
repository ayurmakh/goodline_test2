...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"C:/Users/Аюр/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/Аюр/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
$('.phone').on('keydown', function (e) {
  ...
  $('.phone').removeClass('filled'); // Если введено не число и не backspace, то ничего не делать
  // Если длина номера 3 символа (то есть '+7 ') и нажат backspace, то ничего не делать

  if (e.key.match(/\D/) != null && e.keyCode != 8 || $('.phone').val().length == 3 && e.keyCode == 8) return false;
...
function setChar(pars) {
  if (ind == 15 && pars.mode == '+' || ind == 3 && pars.mode == '-') return;
  var str = $('.phone').val();
...
$('#send-button').on('click', function () {
  ...
  _axios.default.get('https://api.myjson.com/bins/jzrtd').then(function (response) {
...
$('.button-sended').on('click', function () {
...
},{"../sass/main.sass":"../sass/main.sass","axios":"../../node_modules/axios/index.js"}],"C:/Users/Аюр/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
